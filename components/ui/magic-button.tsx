...
const MagicButton = ({text, icon, position, className }: MagicBtnProp) => {
  return<button className="relative inline-flex h-12 w-full overflow-hidden rounded-lg p-[1px] md:w-60 md:mt-10">
