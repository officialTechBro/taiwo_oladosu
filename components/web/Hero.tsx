    ...
    <>
        <BackgroundLines className="h-screen w-full overflow-hidden flex items-center justify-center">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                <h2 className="uppercase tracking-widest text-xs text-center dark:text-blue-100 max-w-80">Independent, Interactive Developer</h2>
                <TextGenerateEffect
                ...
                <p className="text-center capitalize md:tracking-wider my-4 lg:text-2xl text-sm md:text-lg text-neutral-700 dark:text-neutral-400">
                    hi, i&apos;m taiwo, a software developer based  in nigeria.
                </p>
                <a href="#work">
                    <MagicButton 
                    text="show my work" 
